...
static bool GetGlyph2(u16 charCode, u8 *output, int *advance) {
    memset(output, 0, 64);
...
void OnInputFinished(u16 *inputText, int length, bool isCanceled) {
    ...
    if (!namingContext)
        return;
    if (!isCanceled) {
        void (*DrawTextToWindow)(u8 *, u16 *, u32, u32, u32, u32, u32, u32) = (void (*)(u8 *, u16 *, u32, u32, u32, u32, u32, u32))0x02083FE1;
        void (*FillTextWindow)(u8 *, u8) = (void (*)(u8 *, u8))0x201D62D;
        void (*MoveCharCursor)(u8 *, u16, u16) = (void (*)(u8 *, u16, u16))0x020848B9;
